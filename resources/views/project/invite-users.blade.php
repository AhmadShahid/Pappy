                ...
                <div class="person-form-bulk person-form-bulk--fixed form-group append-to" data-role="user_rows_container">
                        ...
                        @foreach($inviteUsers as $key => $user)
                            <div class="person-form-bulk__person clone-html" data-role="existing_user_row" data-user-id="4781518" data-persisted="">
                                <label class="person-form-bulk__attribute">
                                    <input type="text" name="invite[{{$key}}][name]" id="" value="{{$user['name']}}" class="person-form__field input--text" >
                                </label>

                                  <label class="person-form-bulk__attribute">
                                    <input type="email" id="" name="invite[{{$key}}][email]" value="{{$user['email']}}" class="person-form__field input--text" pattern="^\S+@\S+\.[A-Za-z0-9-]{2,23}$">
                                  </label>

                                  <label class="person-form-bulk__attribute">
                                    <input type="text" id="" value="" name="invite[{{$key}}][title]" class="person-form__field input--text" value="{{$user['designation']}}">
                                  </label>

                                  <label class="person-form-bulk__attribute person-form-bulk__attribute--company">
                                    <input type="text" id="" value="{{ $user['organization']['org_name'] }}" name="invite[{{$key}}][organization]" class="person-form__field input--text" >
                                  </label>
                    ...
                    <div class="person-form-bulk__person clone-html" data-role="existing_user_row" data-user-id="4781518" data-persisted="">
                        <label class="person-form-bulk__attribute">
                          ...
                          <label class="person-form-bulk__attribute person-form-bulk__attribute--company">
                            <input type="text" id="" value="" name="invite[{{$key}}][organization]" class="person-form__field input--text">
                          </label>
